...
Test of whether descriptions are throwing things off.
<!-- GitMap-ID: jvredshu -->
...
Allow users to open existing GitMap roadmap files and display them in the desktop workspace using the existing GitMap
parser.
