...
#### 0.7.1.0.8 Skip Unchanged Items During Synchronization (DONE)
...
#### 0.7.1.0.4 Preview Renumbering During Synchronization (DONE)
...
#### 0.7.1.0.9 Display Synchronization Progress (DONE)
